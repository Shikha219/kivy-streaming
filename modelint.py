...
class Modelint(MDApp):
    ...
    def get_data(self, email, password):
        ...
        if (flag):
            ...
            rtsp.append(
                "rtsp://{}:{}@{}:554".format(result[i]['Username'], result[i]['Upassword'], result[i]['IpAddress']))
...
if __name__ == "__main__":
    ...
    LabelBase.register(name="MPoppins", fn_regular="fonts/fonts/Poppins-Medium.ttf")
    LabelBase.register(name="BPoppins", fn_regular="fonts/fonts/Poppins-SemiBold.ttf")
